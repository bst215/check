...
def main():
    ...
    if paper is not None and response is not None:
        try:
            ...
            st.write("There is Some issue with extracting the data. please check the files provided. if the files provided are correct, there might be some issue with the application. we will get back to you soon.")
